  ...
  return (
    <>
      <div className="container">
        <div
          className="start-wrapper card p-4 shadow-lg"
          style={{ maxWidth: "800px", height: "400px" }}
        >
          {" "}
          {/* Added inline styles for width and height */}
          <div className="row">
            <div className="col-12">
              <div className="text-center">
                ...
                <div className="signup-btn mt-5">
                  <Link href="/wizard-master" className="btn btn-signup mx-2">
                    {translationDataFromStore?.data?.start}
                  </Link>
                  <Link
                    href="/signup-later"
                    className="btn btn-later mx-2 mt-0"
                  >
